 ...
 * <br>
 * @Title: CssModelRightFridCell.java
...
/**
 * @ClassName CssModelRightFridCell
 * @Description TODO 表格右边框模型
 * @author piaozg
 * @date 2012-8-10
 */
public class CssModelRightFridCell implements ModelRoot {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CssModelRightFridCell other = (CssModelRightFridCell) obj;
		if (borderColor == null) {
	...
	public String toString() {
		return "CssModelRightFridCell [borderColor=" + borderColor
