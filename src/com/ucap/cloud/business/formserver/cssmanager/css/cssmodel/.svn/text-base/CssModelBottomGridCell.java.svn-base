 ...
 * <br>
 * @Title: CssModelBottomGridCell.java
...
/**
 * @ClassName CssModelBottomGridCell
 * @Description TODO 表格底部模型
 * @author piaozg
 * @date 2012-8-10
 */
public class CssModelBottomGridCell implements ModelRoot {
	/**
	 * 
	 */
	...
	public String toString() {
		return "CssModelBottomGridCell [borderColor=" + borderColor
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CssModelBottomGridCell other = (CssModelBottomGridCell) obj;
		if (borderColor == null) {
