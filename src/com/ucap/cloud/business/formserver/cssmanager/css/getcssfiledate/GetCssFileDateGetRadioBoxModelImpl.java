 ...
 * <br>
 * @Title: GetCssFileDateGetRadioBoxModelImpl.java
...
/**
 * @ClassName GetCssFileDateGetRadioBoxModelImpl
 * @Description TODO <P>解析idf中所有的radibox控件并生成css样式</P>
 * @author piaozg
 * @date 2012-8-10
 */
public class GetCssFileDateGetRadioBoxModelImpl implements CssUntilGetAllModel {

	@SuppressWarnings("unused")
	private Logger logger = Logger.getLogger(this.getClass());

	public GetCssFileDateGetRadioBoxModelImpl() {
	...
	public String getStringCss(Element e) throws Exception {
		...
		if (Integer.valueOf(br.getLeft()) != 0) {
			s.append(" ").append(br.getBorderSize()).append("").append("px ;");
		} else {
			s.append(" 0px ;");
		}
		// 文本字体的
