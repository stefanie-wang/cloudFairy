 ...
 * <br>
 * @Title: CssModelSlashGridCell.java
...
/**
 * @ClassName CssModelSlashGridCell
 * @Description TODO 表格边框属性
 * @author piaozg
 * @date 2012-8-10
 */
public class CssModelSlashGridCell implements ModelRoot{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CssModelSlashGridCell other = (CssModelSlashGridCell) obj;
		if (borderColor == null) {
	...
	public String toString() {
		return "CssModelSlashGridCell [borderColor=" + borderColor
