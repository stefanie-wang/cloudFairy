 ...
 * <br>
 * @Title: GetCssFileDateGetCircleModelImpl.java
...
import com.ucap.cloud.business.formserver.cssmanager.css.cssmodel.CssModelCircleModel;
...
/**
 * @ClassName GetCssFileDateGetCircleModelImpl
 * @Description TODO <P>解析idf中所有的circel控件并生成css样式</P>
 * @author  piaozg
 * @date 2012-8-10
 */
public class GetCssFileDateGetCircleModelImpl implements CssUntilGetAllModel {

	private static Logger log = Logger
			.getLogger(GetCssFileDateGetCircleModelImpl.class);

	@SuppressWarnings("unused")
	private Logger logger = Logger.getLogger(this.getClass());

	public GetCssFileDateGetCircleModelImpl() {
	...
	public Map<String, Object> getModel(Element e) {
		...
		CssModelCircleModel ci = new CssModelCircleModel(); // 圆模型
		ci.setIsShowBorder(e.attributeValue("isShowBorder"));
		ci.setPrintable(e.attributeValue("printable"));
	...
	public String getStringCss(Element e) throws Exception {
		...
		CssModelControlsType ct = (CssModelControlsType) map
				.get("controlstype");
		@SuppressWarnings("unused")
		CssModelCircleModel ci = (CssModelCircleModel) map.get("circle");
